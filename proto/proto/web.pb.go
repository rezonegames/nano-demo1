...
func (x *AccountLoginReq) GetPartition() int32 {
	if x != nil {
		return x.Partition
	}
	return 0
...
type AccountLoginResp struct {
	...
	Code      ErrorCode `protobuf:"varint,5,opt,name=code,proto3,enum=proto.ErrorCode" json:"code,omitempty"`
...
func (x *AccountLoginResp) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AccountLoginResp) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *AccountLoginResp) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *AccountLoginResp) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
var file_web_proto_rawDesc = []byte{
	...
	0x4d, 0x0a, 0x0f, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x71, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x96,
	0x01, 0x0a, 0x10, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x12, 0x24, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43,
	0x6f, 0x64, 0x65, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_web_proto_depIdxs = []int32{
	2, // 0: proto.AccountLoginResp.code:type_name -> proto.ErrorCode
